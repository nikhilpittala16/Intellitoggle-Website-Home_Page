...
import { h as hasProtocol, k as isScriptProtocol, i as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, n as executeAsync, e as createError$1, o as toRouteMatcher, q as createRouter$1, r as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BnNSAwaP.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DZgBadgc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CqX6yahz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BD7JR7eI.mjs'));
